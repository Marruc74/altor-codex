...
export const LORE_GROUPS = [
  ...
  },
  {
    ...
    numeral: "VIII",
    title: "Griffinburg",
    link: "The Secret of Griffinburg",
    blurb:
    ...
    people: [
      ...
      { label: "The deep under Griffinburg", name: "The Horror under Griffinburg", link: "The Secret of Griffinburg", image: "/compendium/Adventures/TheSecretOfGripeborg/Demon.jpg", description: "The true monster of the book: a house-huge, many-armed, tusked and horned demon, black as a beetle's back, sealed under the Grindanu hills since before Zorakin had a name and feeding for three centuries on the hill's pilgrims and lords since the seal first failed. Its hide turns ordinary blades, so it takes both the Deathbringer and the Grey Fang working together to open it up. Old death-work, bounded and local, and pointedly not the Crowned One." },
    ],
    places: [
      { label: "Zorakin", name: "Pendon", link: "The Secret of Griffinburg", description: "The capital of Zorakin, a coastal city of the royal mint and the Lyceum, where the trio make landfall at the opening of the job before walking north into the Grindanu hills." },
      { label: "Grindanu hills", name: "Grifton", link: "The Secret of Griffinburg", description: "A hill village in the Grindanu uplands of Zorakin, below the restored castle. It keeps one inn under the innkeeper Harl, and its people know better than to climb the hill after dark." },
    ],
    locations: [
      { label: "Grifton", name: "Castle Griffinburg", link: "The Secret of Griffinburg", description: "The long-abandoned seat of the Griffin marquisate, newly restored, a griffin on its banner. Above ground it is a stately hall; below the wine cellar it opens on far older and worse workings, a buried necromantic order and the chained things and great demon it left behind." },
      { label: "Castle Griffinburg", name: "The Deep Under Griffinburg", link: "The Secret of Griffinburg", description: "The sealed wine cellar and the crypt below it, a locked chain of trapped rooms read off a six-couplet poem: bats and a fire pit and an antimagic shaft, a guardroom of the dead, a false floor and a petrifying pillar, down to a grotto floored with three centuries of the dead. The register is rot, damp and old hunger, never frost." },
    ],
    items: [
      { label: "Reward", name: "The Grey Fang", link: "The Secret of Griffinburg", image: "/compendium/Adventures/TheSecretOfGripeborg/Whaladrugh.jpg", description: "A single-edged falchion, dwarf-forged to bite exactly the kind of old horror that ordinary steel slides off, found in an iron coffer behind a petrifying pillar in the deep. Its weight rides up near the point, a cleaving working blade; Kaelene lands the demon-kill with it and carries it out as her reward and keepsake from the hill." },
      { label: "Keepsake", name: "The Great Helm", link: "The Secret of Griffinburg", description: "An old great helm of heavy make, taken by Bram from the demon's grotto where it lay unmarked and whole amid three centuries of rot, the one untouched thing in all that ruin. It fits him as though beaten to his head, and its cold old craft turns the tusks and horns and teeth of beasts, though not a wielded weapon. It saves his skull from the demon's tusks at the climax." },
    ],
    seeds: [
