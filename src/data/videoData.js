...
const EXTRA_CREATURES = [
  ...
  { group: "Animals", name: "Musk Ox" },
  { group: "Animals", name: "Wolverine" },
  { group: "Animals", name: "King Cheetah" },
  { group: "Animals", name: "Insect Swarm" },
  { group: "Animals", name: "Beaver" },
  { group: "Animals", name: "Barracuda" },
  { group: "Animals", name: "Narwhal" },
  { group: "Animals", name: "Piranha" },
  { group: "Animals", name: "Stingray" },
  { group: "Animals", name: "Aurochs" },
  { group: "Animals", name: "Portuguese Man o' War" },
  { group: "Animals", name: "Wild Boar" },
  { group: "Animals", name: "Spitting Cobra" },
  { group: "Animals", name: "Moose" },
  { group: "Animals", name: "Eagle" },
  { group: "Animals", name: "Llama" },
  { group: "Animals", name: "Reindeer" },
  { group: "Animals", name: "Pig" },
  { group: "Animals", name: "Yak" },
  { group: "Animals", name: "Walrus" },
  { group: "Animals", name: "Dwarf Elephant" },
  { group: "Animals", name: "Giant Shark" },
  { group: "Animals", name: "Giant Rhinoceros" },
  { group: "Animals", name: "Predatory Crane" },
  { group: "Animals", name: "Cave Lion" },
  { group: "Animals", name: "Brown Bear" },
  { group: "Animals", name: "Grizzly Bear" },
  { group: "Animals", name: "Cave Bear" },
  { group: "Animals", name: "Black Bear" },
  { group: "Animals", name: "Lion" },
  { group: "Animals", name: "Tiger" },
  { group: "Animals", name: "Leopard" },
  { group: "Animals", name: "Jaguar" },
  { group: "Animals", name: "Cheetah" },
  { group: "Animals", name: "Saber-toothed Tiger" },
  { group: "Animals", name: "Bison" },
  { group: "Animals", name: "Elephant" },
  { group: "Animals", name: "Mammoth" },
  { group: "Animals", name: "Hippopotamus" },
  { group: "Animals", name: "Hyena" },
  { group: "Animals", name: "Fox" },
  { group: "Animals", name: "Wolf" },
  { group: "Animals", name: "Dire Wolf" },
  { group: "Animals", name: "Wild Dog" },
  { group: "Animals", name: "Venomous Snake" },
  { group: "Animals", name: "Python" },
  { group: "Animals", name: "Alligator" },
  { group: "Animals", name: "Crocodile" },
  { group: "Animals", name: "Shark" },
  { group: "Animals", name: "Dolphin" },
  { group: "Animals", name: "Killer Whale" },
  { group: "Animals", name: "Bat Swarm" },
  { group: "Animals", name: "Rat Swarm" },
  { group: "Animals", name: "Scorpion" },
  { group: "Animals", name: "Spider" },
  { group: "Fable Animals", name: "Alfin" },
  { group: "Fable Animals", name: "Hippocampus" },
  { group: "Fable Animals", name: "Giant Turtle" },
  { group: "Fable Animals", name: "Peryton" },
  { group: "Shapeshifters", name: "Wererat" },
  { group: "Shapeshifters", name: "Hjortid" },
  { group: "Shapeshifters", name: "Eagle-Man" },
  { group: "Shapeshifters", name: "Selkie" },
  { group: "Corporeal Undead", name: "Ghost Horse" },
  { group: "Wraiths & Wights", name: "Lantern-Man" },
