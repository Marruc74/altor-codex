...
seriesPart: 1
tagline: "The Cleansing was never late. It is almost here."
summary: Dismissed mercenaries stumble on a deadly truth - the walled land of Nidland reckons its years longer than the rest of the world, so the archmage's prophesied crusade to cleanse all Ereb is not failed but imminent. The trail of that secret leads beneath the mountains and over the Great Wall to a black fortress, and a sacrifice the prophecy already named.
videoIds: []
sections:
  - title: The Nidlandish Cleansing
    description: "For a century a walled land has waited under its archmage, and a prophesied crusade to cleanse the world is far nearer than anyone has reckoned."
    places:
      - name: Nidland
        description: "A land on the eastern Krunish peninsula, sealed from the world for over a hundred years behind a great wall and ruled by an archmage and his twelve disciples, masters of a dreaded dark magic whose workings few outside its borders have ever seen."
      - name: The Great Wall
        description: "A seven-meter rampart with watchtowers along its length and a garrison in the tens of thousands, shutting Nidland away from the world. Every other tower is held by men; the rest by a bird-shaped magical warden."
    npcs:
      - name: Vicotnik
  ...
  - title: Bedorum
    ...
    places:
      - name: Bedorum
        description: "A small, war-scarred market town on the Grynner plateau, ringed by a wall and famed for its beer, taken for the rebel cause and ruled now by an appointed lord and his council."
      - name: The Anyak Temple
        description: "A marble-and-timber temple to the god of light behind an impenetrable hedge of claw-roses, whose library holds the old prophecy of the Cleansing and the truth of the longer Akrogalian year."
    npcs:
      - name: Argwin
      ...
      - name: Old Man Otho
        description: "A senile old man who in his youth once glimpsed the Great Wall from within, alongside old Ehrman Wall, though where he can no longer recall."
  - title: The Road North
    description: "The way to the wall runs through ravaged country, a robber-haunted forest and the magic-muddling Grynner mountains, where an elf-prince and an oracle alike are met."
    places:
      - name: Hyllmar Forest
        description: "A forest on the road north, prowled by robber bands - and where an elf-prince is found at bay, defending his wounded pegasus against a band of svartalfer."
      - name: The Grynner Mountains
        description: "A range of mineral-rich rock that muddles all magic, where a violent storm drives travelers into a strangely pulling cave, and an oracle waits."
      - name: Ehrman's Valley
        description: "A lonely highland valley with a turf-roofed cabin, home of the one guide who can lead the way toward Nidland."
      - name: The Oracle's Cave
        description: "A pulling cave in the mountains where a masked, skin-wrapped figure greets the chosen and speaks the prophecy in fiery script before vanishing in a flare of light."
    npcs:
      - name: Ehrman Wall
  ...
  - title: Tarat-khon
    ...
    places:
      - name: The North Gate
        description: "The one gate the dwarves of Tarat-khon still keep open: a hall of axe-bearing statues and firing-niches before an inner gate no force or spell can breach, sealed by a hidden mithril key and a word known to one dwarf alone."
    npcs:
  ...
  - title: Ma'tho Fherengi's Vault
    description: "Beneath the mines lies the tomb of a king who ruled before elves, dwarves or men, and the two great relics buried with him."
    places:
      - name: The Burial Vault
        description: "An ancient gold-clad tomb beneath the mines, reached by a fall into its underground lake: halls of statues and living armor, trap-doors and killing gas, a treasure-room of gold, and at its heart the king's sarcophagus."
    npcs:
    ...
    creatures:
      ...
      - name: The Skeletons
        entry: skeleton
        description: "Bound bones loosed by the tomb's traps to cut down those who fall into its pits."
    items:
  ...
  - title: The Hell Fort
    ...
    places:
      - name: The Hell Fort
        description: "A vast fortress of black stone in a ravine, its walls hung with the dead and its eight towers each greater than a castle, garrisoned by thousands and ringed by a war-camp. Screams echo from its laboratories, and the dark magic rules within."
    npcs:
      - name: Achatoth
...
## The Cleansing That Was Never Late

A band of mercenaries, just dismissed from the rebel army of a war-torn land, gather for a farewell feast - and over the talk and the beer they catch a thread that will not let go. A hundred years past, the archmage Vicotnik sealed the land of Nidland behind its great wall and foretold that in a dozen dozen years he would loose a crusade to cleanse the whole world. That span is reckoned to have passed with no crusade, and the world breathes easy. But Nidland's years run three days longer than the rest, so a year fewer has passed within its walls than without: the Cleansing has not failed. It is almost here. To learn it, and one day to break it, is the heroes' fated charge.
...
Over the Great Wall and into Nidland, the heroes are taken - as the prophecy meant them to be - and marched to the Hell Fort, a black fortress of ten thousand soldiers where the disciple Achatoth waits to offer them up so his masters may seize the power to begin the Cleansing. Their one escape is the thing they carried out of the tomb: the imprisoned Punisher, who will free them at the last - and then loose itself upon the fortress in a fire that levels everything for a quarter-mile, while a summoned pegasus bears them clear and the demon turns inward, toward the archmage, and the tale to come.
