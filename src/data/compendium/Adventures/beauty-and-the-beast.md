...
summary: A lost page of a monastery's chronicle leads the party to a war-hoard sealed beneath a mountain lake - guarded by bandits who would rather talk than fight, and by the ghost of the prior who drowned the temple to save it.
videoIds: []
sections:
  - title: Eskilsby & the Trail
    description: "The party comes into a fragment of an old chronicle and follows it to the foot of the Armored-fist clan's fortress, seeking the one man who still remembers the lost monastery."
    places:
      - name: Eskilsby
        description: "A village of some two hundred and fifty souls below the fortress Eriksborg. Mounts and supplies are scarce and dear here - a light horse runs five hundred silver. Home of the aged brother Franz."
      - name: Eriksborg
    ...
    items:
      - name: The Document
        description: "An excerpt from the monastery's chronicle, recovered among the remains of a bandit-struck caravan. Read with Heraldry and History, it points the way to the drowned hoard of the Armored-fist clan."
  - title: Lake Anja & the Bandits
    ...
    items:
      - name: The Bandits' Chest
        description: "Coins and three healing potions hidden among the ruins - which the gang will grab and run with if forced to flee."
  - title: The Drowned Temple
    description: "The hoard lies in the flooded temple beneath Anja's Eye. The real puzzle is getting the water out - without losing the frail guide to the ghost that guards it."
    places:
      ...
      - name: The Guardian Hall
        description: "A vine-choked chamber lit by enchanted ceiling-stones, where a dormant strangle-vine wakes about half an hour after the door is opened and seizes the careless."
    ...
    items:
      - name: The War-Booty
        description: "Bulk coin and two caskets of jewels in the great vault - the seized orc-plunder of baron Eskil, and the prize the chronicle promised."
      ...
      - name: The Holy Silver
        description: "Seven pitchers, seven serving-dishes and forty-nine chalices of the order's silver in the lesser vault - claimable only if no Karl-brother in the party objects."
---

## Plot

The party comes into a torn page of an old chronicle - found, perhaps, among the wreck of a bandit-struck caravan - that tells of a war-hoard hidden beneath a mountain lake. Sixty years ago a svartfolk army overran the region; baron Eskil of the Armored-fist clan crushed one orc band, seized its plunder, and gave it to his brother, the prior of Karl's Monastery, who sealed it in an underground temple beneath the island of Anja's Eye. The baron died breaking out to reach the king; the monastery was stormed and burned. Captured, the prior offered to lead the orc commander to the treasure - then spoke a secret Word that quenched the altar fire, opened hidden channels, and drowned both himself and the raider to keep the hoard safe.

Following the chronicle with Heraldry and History, the party reaches the village of Eskilsby and seeks out brother Franz, the last living man who remembers where the monastery stood. The lake lies a week into the wilds, and its ruined monastery is now held by a band of sympathetic outlaws who would rather bargain than bleed.

## Thinking Beats the Sword

This is a scenario for beginners, and it rewards heads over blades. The bandits under Rickard Hawkwing are no monsters - their leader deserted rather than burn his own village - and they will not fight to the death. Persuade them the party's errand is aimed at the baron, not at them, and they will share the work for an equal cut, sparing a fight against foes who know the ground.

## The Drowned Temple

The treasure sits in the flooded temple under Anja's Eye, down a spiral stair into a drowned shaft, and the heart of the adventure is finding a way to draw the water out. When any living non-svartfolk enters the temple hall, the ghost of prior Edvard rises by the altar and bars the way out until his fire burns again, finding release when it does. Only then do the vaults and their hoard lie open.
