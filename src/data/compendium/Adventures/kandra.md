...
sections:
  - title: Mages' Guild
    description: The five masters of Kandra's Mages' Guild, one for each school of magic, and the tower they keep.
    places:
      - name: The House of Magicians
        description: Magikernas Hus, a hexagonal tower raised around a seven-metre basalt pillar over an ancient grave-mound, with an amphitheatre hall whose floor-pentagram has been argued over for four and a half centuries. It stands under royal charter, and necromancers are barred from it.
    npcs:
      - name: Myndol
  ...
  - title: The Academy
    ...
    places:
      - name: The Academy
        description: The Academy of Kandra, a branch of the University in Entika, with archives, a great library, and scholars of every kind of learning.
    npcs:
      - name: Dr. Gregos
        description: An Academy scholar of human legend, folklore, sociology and demography.
      - name: Dr. Haas
        description: An Academy scholar of the giants, their history, myth, law and language.
      - name: Dr. Ukoul
        description: An Academy scholar of the long war between the dark folk and the elf-folk.
  - title: Council
    description: Those who govern Kandra, headed by its Council Elder, and the town hall they keep.
    places:
      - name: The Town Hall
        description: Rådhuset, the town hall housing the council, the court, the treasury and the holding cells, with the Knights' Hall attached.
    npcs:
      - name: Miandrick Span
  ...
  - title: Military
    ...
    places:
      - name: The Warriors' House
        description: Krigarnas Hus, Milrik of Remos's training arena, where fighters hone their craft under expert instruction.
    npcs:
      - name: Kvarhant
  ...
  - title: Merchants and Craftsmen
    ...
    places:
      - name: The Merchants' House
        description: Köpmännens Hus, a stone warehouse and archive with twin-key strongrooms, the seat of Kandra's traders.
      - name: The Bank
    ...
    npcs:
      ...
      - name: Mästerman
        description: The city's executioner.
    items:
      - name: Mithril
        description: The metal of metals, which only dwarves can forge and none of which is for sale in Kandra.
      - name: Lihand's Mithril Battle-Axe
        description: A battle-axe of mithril forged by the dwarf-smith Lihand himself.
      - name: Lihand's Mithril Ringmail
        description: A short coat of mithril ringmail forged by Lihand, light and proof against hard blows.
      - name: The Sea-Serpent Horn
        description: Sjöormshorn, a prized carving material worked by the city's ivory-carver.
  - title: Crime World
    description: The organized underworld that answers to the King of Thieves.
    places:
      - name: The Thieves' Guild
        description: Tjuvarnas Gille, the guild of thieves fronted as a respectable trading house, the seat of the King of Thieves.
    npcs:
      - name: Ärnvard Ote
  ...
  - title: Taverns
    description: Kandra's many inns and taverns, each the haunt of a different sort of folk.
    places:
      - name: The Floating Log
        description: Flytande Stocken, Kandra's finest inn, kept by Ullman.
      - name: The Eagle and the Child
        description: Örnen och Barnet, the finest tavern in the city, where magicians, knights and adventurers take their ease.
      - name: The Emperor's Shoe
        description: Kejsarens Sko, the city's book-café, where scholars and lawyers debate.
      - name: The Flying Wheel
        description: Flygande Hjulet, a cheap dive where the city's worst dregs gather.
    npcs:
      - name: Ullman
        description: The innkeeper of the Floating Log, Kandra's finest inn, who came to the city as a boy from the village of Munkalid.
  - title: Temples
    description: The temples of the Young Gods who cast down the Old Gods, and the cloister of meditating monks.
    places:
      - name: The Great Temple
        description: The largest temple of Kandra, raised to Sholak the sun-god, Visha of the harvest and Ninnave of love and the hearth.
      - name: The Temple of Kushta
        description: The death-temple of Kushta, guardian of the realm of the dead and foe of the undead state, richly adorned with grave-offerings.
      - name: The Moon-Temple
        description: A hidden temple to Eilana, goddess of the moon and ruler of the night.
      - name: The Cloister
...
Long ago, adventurers dug into a burial mound on the site and found no treasure, but a magician among them summoned dozens of his fellows, who sealed the mound inside a tabernacle. From this grew Kandra's great Academy and its Mages' Guild, led by five master magicians, one for each school of magic: Crondo the animist, Myndol the mentalist, Isokles the elementalist, Castor the symbolist and Kyhara the illusionist.

### The Council and the Watch

The city is governed by a Council under its Council Elder, who also presides over the court; the post is held by the shrewd politician Miandrick Span. Order is kept by the city watch, one of the best-drilled in Berendia, under its commandant Kvarhant, who answers directly to the Council Elder and often finds his strict sense of justice at odds with Miandrick's pragmatism.

### The Warriors' House

The retired hero Milrik of Remos has built a training arena, the Warriors' House, where fighters can hone their craft under expert instruction, aided by his skilled elf assistant Ziosiana.

### The Thieves' Guild

All organized crime answers to the Thieves' Guild, hidden behind the front of a trading house and ruled by its grandmaster, the King of Thieves, Ärnvard Ote. The Council strongly suspects what goes on within its walls but has never been able to prove a thing.
