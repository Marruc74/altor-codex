...
seriesPart: 3
tagline: "To end the archmage, first summon the light that answers his dark."
summary: The close of the Nidlandish Cleansing. With the dark Punisher loosed in the archmage's service, the heroes are sent to a dead necromancer-land to win the Twin Staff, to the buried city of mages to summon its bright twin, and at last over the Great Wall to the archmage's own tower for the reckoning that ends the war.
videoIds: []
sections:
  - title: Landori
    description: "A month into an uneasy victory, the elf-king gathers Ereb's heroes for a way to end the archmage at last - and the gathering is betrayed before it can begin."
    places:
      - name: The Tree-Castle
        description: "The living castle of the elf-king, hidden behind the forest's magical girdle, where Ereb's heroes are gathered and the great teleportation is worked in the Hall of Flowers."
      - name: The Thousand-Year Oak
        description: "The ancient oak in Landori's protective girdle, passed only by speaking the right words - a secret now betrayed to the enemy's spying eye."
    npcs:
      - name: Pargal
  ...
  - title: Yndar
    description: "A dead, blood-skied land of necromancers, where a petrified god holds the staff that can summon the world's salvation."
    places:
      - name: Yndar
        description: "A dead wasteland beneath a blood-red sky, once home to a high culture that delved too deep, now haunted by necromancers who worship a petrified god."
      - name: The Lava Ravine
        description: "A chasm five miles deep of fire and ash, crossed amid eruptions, lava-lizards and sandstorms on the road to the petrified god."
      - name: The Petrified Forest
        description: "A forest turned wholly to stone, stalked by leather-birds and night-cats."
      - name: Hertach
        description: "A mountain that is a petrified god, his stone arm thrust from the summit holding the Twin Staff sealed in crystal within a giant clawed hand; seven arches lead into his chambers."
    npcs:
      - name: Daechetuen
  ...
  - title: Kabsah's Desert
    ...
    places:
      - name: Kabsah's Desert
        description: "A vast golden sand-sea of mirages, nomads, sand-dragons and red vultures, beneath which the buried city of mages lies hidden."
      - name: Aborghin's Rock-Dwelling
        description: "A hermit-mage's home cut into the desert rock, with its oasis-garden and library - and a hidden laboratory of forbidden work."
    npcs:
      - name: Aborghin
  ...
  - title: Densel
    description: "The buried city of mages, being dug open by the archmage's servants, whose heart alone holds power enough to free the world's salvation."
    places:
      - name: Densel
        description: "A city of mages buried under the desert, crowned by a hundred-meter statue and a deliberately leaning tower, now being excavated by a Nidlandish expedition under the dark Punisher."
      - name: The Citadel
        description: "The central pyramid of Densel, whose hidden pentagram opens a way down through four magical labyrinths of stone warriors, traps, conjured enemies and shifting rooms."
      - name: The Storms' Hall
        description: "The heart of Densel at the foot of a six-mile stair, its walls painted with Fate's own prophecy, where the Good Punisher can be summoned."
    npcs:
      - name: Rashar
    ...
    creatures:
      ...
      - name: The Dark Riders
        description: "The archmage's helmed knights at Densel, masked as a dragon, a bull, and a beautiful woman."
  - title: Hynsolge
    description: "Sent home with the world's salvation in hand, the heroes learn the rot they must cut out lies in the hand of the queen they crowned."
    places:
      - name: Bedorum
  ...
  - title: Khaanikel
    description: "Over the Great Wall to the archmage's own tower, and the reckoning that ends the Cleansing."
    places:
      - name: Khaanikel
        description: "The capital of Nidland behind the Great Wall, site of the archmage's palace and the tower where the last battle falls."
    npcs:
      - name: Vicotnik
    ...
    creatures:
      ...
      - name: The Silver Elves
        entry: silver-elf
        description: "Shaven, black-winged silver elves, branded and yoked to the archmage's flying galleys, set free when his power breaks at last."
    items:
      - name: Hytrang
        description: "The archmage's two-handed demon-blade, borne with robes warded against all harm."
---

## The Light Against the Dark

A month after a crown was won at a terrible price, the heroes are summoned to the elf-king's living castle, where Ereb's heroes have gathered around a single hope: a way to destroy the archmage at last. The dark Punisher loosed at the Hell Fort now fights in his service, and only its bright twin can answer it. But the gathering is betrayed - a black raptor strikes down the prince who brought the call, and when the great teleportation is worked, it is sabotaged, and only the heroes reach the road ahead.

## The Twin Staff

That road runs first through Yndar, a dead land of blood-red skies and necromancers, to a mountain that is a petrified god, in whose stone hand the Twin Staff lies sealed. Won past its serpent-guardian, the staff drags the heroes toward the buried city of mages - by way of a desert and a hermit who is not what he seems - for only at Densel's heart, beneath four magical labyrinths, is there power enough to summon the Good Punisher. There the two titans meet, and the bright one casts down the dark.
