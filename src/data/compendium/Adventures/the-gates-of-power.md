...
sections:
  ...
  - title: Ground Level
    description: The gatehouse just inside the doors, the welcome hall, the guardrooms and the armouries, watched by skeleton archers.
    places:
      - name: The Welcome Hall
        description: A great hall of polished bedrock lined with niches and dwarf-statues in grave silence. A scribe-statue will show a map of the level above to a dwarf, elf, giant or halfling who asks it aloud, while skeleton archers wait behind loopholes to fire on any who step into the hall without the spoken passphrase.
      - name: The Guardrooms
        description: Rooms with peep-slits in the outer wall where skeleton sentries watch the approach to the gates and raise the alarm for Mogdath, with hidden sliding doors leading on toward the lower levels.
      - name: The Armouries
  ...
  - title: Upper Level
    ...
    items:
      ...
      - name: Val-Eloth
        description: The Headband of Sight, a band of finest white gold set with sapphires and rubies worked into delicate engraving, kept in the locked Council Hall chest. Touch its largest ruby and it grants the wearer a spell of farseeing.
      - name: Cerenoinen
        description: The Staff of the Elements, a half-metre rod of pure platinum set with seven gems, one for each element, holding within it a summoning for an elemental of every kind, drawn from the wielder's own spirit.
      - name: Heart of the Mountain
        description: A single ruby weighing a thousand carats, among the treasures Mogdath saved from the cave-in and locked away in the Council Hall chest.
      - name: Mithril Ingots
        description: Twenty-five ingots of mithril kept in the Council Hall chest, a small fortune in the dwarves' wondrous metal, behind a lock that is very hard to pick.
  - title: The City
    description: The dwarven city proper, with its barracking orcs, its crushing treasure-trap, and the consecrated chapel that hides one of the ways out.
    places:
      - name: The Dwarven City
        description: The dwarves' city proper, hewn from the rock with mirror-polished walls, the air carrying roast meat, burning coal and a hint of sulphur. The orcs barrack here under Blacktooth, and a black stone podium bears a jewelled golden statue and a hoard of coin and arms.
      - name: The Treasure Trap
        description: An enormous hoard heaped around a three-metre gilded gnome-statue, the podium itself a trap, for a weight upon it breaks the four pillars and brings down the ceiling, leaving but a moment to flee. Two manticores guard it so the orcs do not spring it, and among the gold lie six potent magic items. Of seven such trap-hoards, greedy orcs sprang the other six and buried themselves with the riches.
      - name: The Chapel
        description: A consecrated shrine to Karkor, the earth-god who made the dwarves from the rock, its walls painted with gold-leaf and gems, its pillars and altar warded with deadly sigils against dark folk, undead and intruders. The dwarf priest's ghost appears at the altar, and none of Mogdath's people dare enter for fear of defiling it.
      - name: The Well and Latrines
    ...
    items:
      - name: Lefaleth
        description: The Amulet of Life, a teardrop sapphire set in a golden rose; rubbed against living skin it heals wounds, drawing its power from nature. Hidden among the hoard of the Treasure Trap.
      - name: Balz-For
        description: The Sceptre of Lightning, a half-metre white-gold sceptre tipped with a cut diamond that looses a bolt of lightning at a spoken word, at a cost to the user's spirit.
      - name: Ish-Taloch
        description: The Sword of Frost, a mithril short sword graven with twining patterns that looses a blast of frost when drawn from its sheath, the cold added to the blade's bite, drawing its power from nature.
      - name: Absor
        description: The Shield of the Mountain, a medium oak shield bound with mithril that raises a ward of resistance at a spoken word, at a cost to the bearer's spirit.
      - name: Wayfinder
        description: A ring of red gold set with a pearl; slipped onto the right little finger it teleports the wearer two hundred metres to any spot they choose, drawing its power from nature.
      - name: Sqidlak
        description: The King's Armour, a coat of mithril mail that raises a protective ward each time a weapon strikes it, drawing its power from nature.
      - name: The Chapel Altar
        description: The far table of the chapel, an altar of marble, mithril, gold, silver and platinum, immensely valuable and immensely heavy, holding a powerful lightning-sigil that fires if the altar is moved; the chapel's pillars and side-altar are warded with sigils of their own.
  - title: The Forge and Mine
    description: The lowest levels, where the forge still works and the iron is dug, worked by orcs and the ogres under the dark wraiths' watch.
    places:
      - name: The Forge
        description: The smithy, its eastern half roughly hewn and its western half polished, hot, smoky and thick with soot, where orcs work a blast-furnace and forge weapons, with a hoist and stairs leading down to the mine and a locked armoury of orc-made arms.
      - name: The Mine
...
- **The city.** The dwarven city proper, where a treasure-laden golden statue stands on a podium that is itself a crushing trap, the orcs barrack under their cruel leader Blacktooth, and a consecrated chapel holds the spirit of a dwarf priest and the sigil-warded riches he guards.
- **The forge and mine.** The lowest levels, where the forge still works and the iron is dug. Exhausted orcs and the ogres labour here under the watch of the dark wraiths Daz and Gozer.
