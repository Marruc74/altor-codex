...
sections:
  - title: The Prophecy of Ranz
    ...
    creatures:
      - name: Adgurbog
        description: "Gobrugda's mighty horn-demon bodyguard, bound to him in thought, that recognizes Peatro's brass bell from miles off and guards the way through the swamp."
      - name: Reptile Undead
        entry: reptileman
        description: "The risen reptile-men that keep watch over Gobrugda's island in the Shadow Swamp."
      - name: Spider-Vines
        entry: spider-vine
        description: "Grasping, predatory vines that snare the unwary among the swamp's stakes and cairns."
    items:
      - name: Ebharing
  ...
  - title: The White Eye - Raoga
    ...
    items:
      - name: The Four Mirrors
        description: "The twins' enchanted glasses: one that looses a hateful mirror-double of the viewer, one that turns the gazer to stone, one that strips away flesh to the bone for the eye, and one that carries the viewer away across distance."
      - name: The Pandora Orb
        description: "Kamalkus's black orb talisman. Should it ever be opened, golden butterflies pour out and wake Nekromorbus, a perfect, deathless statue-warrior that hunts the one who opened it without rest."
      - name: The Tower-Models
        description: "Silver figurines in models of the citadel that whisk people between its matching rooms."
  - title: The Blue Eye - the Blue Child
    description: "In a drug-ruined city, a floating cliff held aloft by a chained fire-spirit cradles a strange blue child - worshipped as innocence itself, and far more than it seems."
    places:
      - name: Skuger
    ...
    creatures:
      - name: Basenanji
        description: "A giant invisible fire-spirit bound by a silver thread to hold up Skuger's floating cliff. It longs only for freedom to return to its distant fire-lake."
    items:
      - name: Fafalder's Mantles
        description: "Red temple robes marked with a gold hourglass that let the wearer see the invisible fire-spirit Basenanji."
  - title: The Red Eye - Nastigast
    description: "In a vast canyon of magnetic cliffs and cascade-lightning, a sacrificial cult keeps a fat genius as its oracle, walled behind a labyrinth of deadly traps."
    places:
      - name: Hoska's Canyon
        description: "A great canyon in the homeland of the birch-folk, riddled with magnetic cliffs, drifting water-bodies, cascade-lightning and an iron taboo, with a trading ground and a lonely border fort."
      - name: The King's Cliff
  ...
  - title: Foes & Factions
    ...
    creatures:
      - name: Shaggira
        description: "A psyche-parasite demon Shagul keeps as a spy, which possesses its victims, drains their minds week by week, and can draw a brain out through the ear."
      - name: Lugahs
...
## The Prophecy of the Fifth Conflux

The prophecy Vox Ranzina has been completed at the holy living mountain of Ranz. It foretells the fifth conflux - a fated point in time and place that will shape the world to come. The deathless sorcerer Shagul, an astrologer himself, believes the conflux will fall on the northern island he rules through King Ottar's risen dead, and means to seize it and draw his demon fully into the world. To blind all others to its timing, he has loosed the assassins of RhabdoRana to murder every rival astrologer in Trakorien.

But a hidden verse warns that Shagul will fall to someone who has seen his true face - the very adventurers who unmasked him on Marjura. So he hunts them too, even as the monks of Ranz search for them, for the secret verses are meant for their hands. Those verses speak of four eyes: four seer-creatures who must be saved before Shagul's killers find them, lest the conflux fall to him.
