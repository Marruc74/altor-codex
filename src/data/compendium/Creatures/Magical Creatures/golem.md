...
The classic golem is shaped from dead clay by a master of elemental magic, who binds into the lifeless body the powers of all seven elementals at once, together with a stroke of lightning to wake them. The discharge is tremendous, and a single botched binding wrecks the clay and savages the maker, but where it succeeds the clay rises a living servant. It comes into the world knowing nothing at all and must be taught everything as a child is, beginning with speech, and however long it is schooled it never grows truly clever and can never be taught to work magic of any kind.
...
A golem is immune to sleep, poison and disease, never needs to rest, sleep or eat, and takes no harm from bleeding. When its body is finally destroyed it explodes, the bound elemental powers bursting free all at once to harm everything nearby. A creature turned to stone by magic and then made a golem keeps the skills of its former life, but a golem can never work any kind of magic.
